...
def printMonthTitle(year, month):
	...
	print('----------------------------')
	print('{n1:<4s}{n2:<4s}{n3:<4s}{n4:<4s}{n5:<4s}{n6:<4s}{n7:<4s}'.format(
		n1 = 'Sun', n2 = 'Mon', n3 = 'Tue', n4 = 'Wed', n5 = 'Thu',
		n6 = 'Fri', n7 = 'Sat'))
...
def getStartDay(year, month): 
	START_DAY_FOR_JAN__1_1800 = 3

	totalNumberOfDays = getTotalNumberOfDays(year, month)

	return (totalNumberOfDays + START_DAY_FOR_JAN__1_1800) % 7
